...
<br>
				<ul id="menu-toc" class="menu-toc">
					<li class="menu-toc-current"><a href="#item1">NOTICES</a></li>
					<li><a href="#item2">STUDENT LIST </a></li>
                                        <li><a href="#item3">uploaded files</a></li>
					<li><a href="#item4">UPLOADING ASSIGNMENTS</a></li>
                                         <li><a href="#item5">LOG OUT</a></li>
...
<div class="bb-custom-wrapper">
        ...
        BATCH:<t> <t><t> <t><input type="text" name = "batch" placeholder="F6" required="required"><BR><BR>
       BRANCH:<t> <t><t> <t><input type="text" name = "branch" placeholder="cse/ece" required="required"><BR><BR> 
        NOTICE/NOTICE-NAME:<input type="message" name = "notice" placeholder="your text here" required="required"><BR><BR> 
     <br><br>
    ...
    <br><br><br><br>
                            ...
                            <div class="bb-item" id="item2">
                                  <div class="content">
                                    <div class="scroller">
                                       <h2>STUDENT LIST</h2>
					<p>LIST OF STUDENT WHO SUBMITTED ASSIGNMENT.</p>
                            <form action="stulis.php" method="post" enctype="multipart/form-data">
    <!-- NAME: <input type="text" name = "tname" placeholder="teacher name" required="required"><t><t>--->
    BATCH: <input type="text" name = "batch" placeholder="batch"required="required"><t><t>
    YEAR: <input type="text" name = "year" placeholder="year"required="required"><t><t>
     <input type="submit" value="see all files">
	<br>	 </form>	
    <br>
    <br>
    <br>
       ...
       UPLOADED FILES
        <?php include ('listup.php');?>
             ...
             <div class="bb-item" id="item4">
                <div class="content">
              <div class="scroller">
                   <h2>UPLOADING ASSIGNMENTS</h2>
                  <p>UPLOAD ASSIGNMENT HERE</p>
    <!--<form action ="add_file1.php" method ="post" name="myform" id="myForm">
          YEAR: <select name="year" id="year" size="1">
            <option value="">Selectyear</option>
                      </select><T><T>
       SEMESTER:<select name="sem" id="sem" size="1">
         <option value="">select semester</option>
       </select><T><T>
     SUBJECT: <select name="subject" id="subject" size="1">
       <option value="" >select subject </option>
       </select><T><T> -->
       <form action="add_file.php" method="post" enctype="multipart/form-data">
       SUBJECT:<input type="text" name = "subject" placeholder="in capital letter" required="required"><BR><BR> 
        YEAR:<t> <t><t><t><t> <t><t><t><t><input type="text" name = "year" placeholder="1,2,3,4" required="required"><BR><BR>
      BATCH:<t> <t><t> <t><input type="text" name = "batch" placeholder="F6" required="required"><BR><BR> 
      LAST DATE OF SUBMISSION <input type="DATE" name = "sdate" placeholder="dd-mm-yyyy"required="required"><BR><BR> 
     ATTACH FILE:<t> <t><input type="file" name="uploaded_file" required="required">
     <br><br>
